#ifndef SOURCE_STYLES_HPP
#define SOURCE_STYLES_HPP
...
void DarkStyle2()
{
	...
	colors[ImGuiCol_WindowBg] = ImVec4(0.10f, 0.10f, 0.10f, 0.20f);
...
// #TODO need some fixes in colors of hovered items
void WhiteStyle1()
{
